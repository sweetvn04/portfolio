...
export default function ContactForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch(form.action || 'https://formspree.io/f/mnjqlkkr', {
  ...
  return (
    <>
      <form action="https://formspree.io/f/mnjqlkkr" method="POST" className="space-y-4" onSubmit={handleSubmit}>
