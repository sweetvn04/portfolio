    ...
    async function fetchProjects() {
      try {
        ...
        const myCustomProjects: GitHubRepo[] = [
          ...
          // {
          //   id: 9992,
          //   name: "AI VTuber Assistant",
          //   full_name: "my/ai-vtuber",
          //   description: "Interactive Virtual Character responding to voice commands using React and Python backend.",
          //   html_url: "#",
          //   homepage: null,
          //   stargazers_count: 25,
          //   forks_count: 5,
          //   language: "TypeScript",
          //   topics: ["React", "AI", "Python", "Live2D"],
          //   created_at: new Date().toISOString(),
          //   updated_at: new Date().toISOString(),
          //   pushed_at: new Date().toISOString(),
          // }
        ...
        // Merge custom projects with fetched projects
        // Using 'any' casting briefly to bypass strict type check for mock props if needed, but GitHubRepo interface matches mostly.
        setProjects([...myCustomProjects, ...data]);
